...
<div class="corpo rg">
  <div class="rg__col">
    ...
    <ul class="rg__l">
      ...
      <li><b>Um azul só.</b> Cheio em bloco preenchido, claro em traço e texto sobre escuro.</li>
      <li><b>Alterne as superfícies.</b> Nenhuma dobra clara encosta em outra clara.</li>
  ...
  <div class="rg__col rg__col--nao">
    ...
    <ul class="rg__l">
      ...
      <li><b>Sem cor de estado inventada.</b> Sucesso, erro e aviso saem do mesmo azul ou do neutro.</li>
...
<div class="rg__rod">
  <div>
    <div class="rot" style="color:var(--brand)">Onde tudo isso mora</div>
  ...
  <div>
    <div class="rot" style="color:var(--brand)">Peso</div>
    <p class="nota" style="margin:8px 0 0">HTML, CSS e JavaScript puros, sem build e sem dependência.
      A fonte são 93 KB; o JavaScript da página, 200 linhas.</p>
  </div>
</div>"""

CSS_REGRAS = """
.rg{ display:grid; grid-template-columns:1fr 1fr; gap:34px; }
.rg__col{ border-top:2px solid var(--brand); padding-top:16px; }
...
.rg__t s{ width:20px; height:20px; background:var(--brand); color:#fff; text-decoration:none;
...
FIM = """<section class="slide pg pg--azul fim">
  <div class="fim__marca">atalho</div>
  ...
  <div class="fim__pe"><span class="micro">contato@atalhostudio.com.br</span><span class="micro">Atalho Studio · São Paulo</span></div>
</section>"""
