...
<p class="sub">Três fundos, e cada um traz seu próprio conjunto de cores de texto, de régua e de botão.
  A alternância entre eles é o que dá ritmo à rolagem: nenhuma dobra clara encosta em outra clara. Repare na inversão dos botões.</p>
<div class="corpo sup">
  <div class="sf sf--papel">
    <div class="sf__topo"><span class="rot">Papel</span><code>--paper #e4e0d9</code></div>
    <div class="sf__demo">
  ...
  <div class="sf sf--tinta">
    <div class="sf__topo"><span class="rot">Tinta</span><code>--ink #131211</code></div>
    <div class="sf__demo">
      <div class="sf__h">Como um projeto anda.</div>
      <p class="sf__p">Texto em <code>--on-dark-70</code>; régua a 15%.</p>
      <div class="sf__btns"><span class="bt bt--claro">Iniciar projeto</span><span class="bt bt--ghostd">Ver projetos</span></div>
    </div>
...
<div class="corpo cp">
  ...
  <div>
    ...
    <div class="cx">
      <span class="micro" style="color:var(--ink-35)"><b style="color:var(--ink)">03</b> &nbsp; Serviços</span>
