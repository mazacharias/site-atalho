...
<title>Atalho Studio · Sistema visual</title>
<style>
...
:root{
  --brand:#182889; --brand-deep:#0f1a5e; --brand-claro:#5a6ce2;
  --brand-lift:#23359f; --brand-soft:#e7e9f4; --brand-tint:rgba(24,40,137,.08);
  --ink:#0c0d12; --ink-2:#16181f;
  --ink-70:rgba(12,13,18,.70); --ink-50:rgba(12,13,18,.50); --ink-35:rgba(12,13,18,.35);
  --line:rgba(12,13,18,.13); --line-soft:rgba(12,13,18,.07);
  --paper:#f4f4f1; --paper-2:#fafaf8;
  --on-dark:#f2f2ee; --on-dark-70:rgba(242,242,238,.70); --on-dark-45:rgba(242,242,238,.45);
  --on-dark-line:rgba(242,242,238,.15); --line-dark:rgba(90,108,226,.42);
...
.pg--azul{ background:var(--brand); color:var(--on-dark); }
...
.pg--escura .micro,.pg--azul .micro{ color:var(--on-dark-45); }
.micro b{ color:var(--brand); font-weight:600; }
.pg--escura .micro b,.pg--azul .micro b{ color:var(--brand-claro); }
...
.pg--escura .nota,.pg--azul .nota{ color:var(--on-dark-70); }
...
def pagina(n, total, secao, corpo, classe=''):
  ...
  <div class="topo">
    ...
    <span class="micro">Atalho Studio · Sistema visual</span>
  </div>
  {corpo}
</section>
"""
