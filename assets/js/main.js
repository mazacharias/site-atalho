...
(function () {
  ...
  /* ---------- 6. Vídeo ----------
     O pôster só dá lugar ao player quando alguém clica: nada de vídeo
     é baixado antes disso. Funciona com arquivo local (data-src) ou com
     YouTube/Vimeo (data-youtube / data-vimeo). Veja o LEIA-ME.md.      */
  document.querySelectorAll('.video').forEach(function (fig) {
    ...
    btn.addEventListener('click', function () {
      ...
      if (yt || vm) {
        ...
        // WebM primeiro (menor) e MP4 como garantia: o navegador escolhe
